   ...
   * Complex chart rendering function that handles multiple chart types
   * Extracted from index.html lines 43549-45265
   */

  import { generateChartColors } from '../utils/chartColors.js';
  import { isDarkMode, getTextColor, getGridColor, getScatterPointColor } from '../utils/themeUtils.js';
  import { setChartInstance } from '../utils/chartRegistry.js';
...
''}
    ...
    setTimeout(() => {
        ...
        if (chartData.chartType === 'bar' || chartData.chartType === 'histogram') {
            ...
            setChartInstance(chartId, chart);
